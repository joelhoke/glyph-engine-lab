...
/**
 * Share iOS Export icon
 * Source: SVG Repo, https://www.svgrepo.com/svg/511124/share-ios-export (CC0)
 */
export default function ShareIosExportIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="12"
