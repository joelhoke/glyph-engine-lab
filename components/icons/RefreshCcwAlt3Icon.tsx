...
/**
 * Refresh CCW Alt 3 icon
 * Source: SVG Repo, https://www.svgrepo.com/svg/533698/refresh-ccw-alt-3 (CC0)
 */
export default function RefreshCcwAlt3Icon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="12"
